        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group p-8 bg-white dark:bg-neutral-900 rounded-2xl border-2 border-gray-200 dark:border-neutral-800 hover:border-green-500 dark:hover:border-green-500 hover:shadow-xl transition-all duration-300"
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="w-16 h-16 bg-green-50 dark:bg-green-950/40 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white">WhatsApp</h3>
              </div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group p-8 bg-white dark:bg-neutral-900 rounded-2xl border-2 border-gray-200 dark:border-neutral-800 hover:border-indigo-500 dark:hover:border-indigo-500 hover:shadow-xl transition-all duration-300"
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="w-16 h-16 bg-indigo-50 dark:bg-indigo-950/40 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white">Discord</h3>
              </div>
              <p className="text-gray-600 dark:text-gray-400 mb-4 leading-relaxed">
          ...
          {/* Email & Socials */}
          <div className="p-8 bg-white dark:bg-neutral-900 rounded-2xl border border-gray-200 dark:border-neutral-800 mb-8">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 bg-red-50 dark:bg-red-950/40 rounded-2xl flex items-center justify-center">
                <MailIcon className="w-8 h-8 text-red-600 dark:text-red-400" />
              </div>
              <div>
            ...
            <div className="pt-6 border-t border-gray-200 dark:border-neutral-800">
              <p className="text-sm font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-4">
                Follow us
              </p>
              <SocialLinks />
            </div>
          ...
          {/* Location Card */}
          <div className="p-8 bg-gradient-to-br from-red-50 to-blue-50 dark:from-red-950/30 dark:to-blue-950/30 rounded-2xl border border-gray-200 dark:border-neutral-800 mb-16">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-16 h-16 bg-white dark:bg-neutral-900 rounded-2xl flex items-center justify-center">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-2 font-medium text-lg">Biratnagar, Nepal</p>
          ...
          {/* CTA Section */}
          <div className="text-center p-12 bg-black dark:bg-neutral-900 dark:border dark:border-neutral-800 rounded-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-red-600 to-red-500 dark:from-red-500 dark:to-red-400 text-white rounded-full font-semibold text-lg hover:shadow-lg hover:shadow-red-600/30 transition-all transform hover:scale-105"
              >
                Join the Club
                <span>→</span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-8 py-4 bg-indigo-600 dark:bg-indigo-500 text-white rounded-full font-semibold text-lg hover:bg-indigo-700 dark:hover:bg-indigo-400 transition-all transform hover:scale-105"
              >
                Join via Discord
                <span>→</span>
              </a>
